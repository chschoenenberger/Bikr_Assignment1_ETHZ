...
/**
 * This class handles all the navigation. If a user presses on a feature which is contained in the
...
class Navigation extends DefaultMapViewOnTouchListener {
     ...
     */
    Navigation(Context context, MapView mapView) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            ...
                            case DialogInterface.BUTTON_NEGATIVE:
                                Toast.makeText(mContext, "Navigation canceled!", Toast.LENGTH_SHORT).show();
    ...
    /**
     * Navigation task itself which accesses the routing service and displays the route on the provided
     * MapView
     *
